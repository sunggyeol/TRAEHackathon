...
const SYNTH_PROMPTS: Record<string, string> = {
  ...
  unify: '당신은 여러 에이전트의 데이터 검증 결과를 종합하여 통합 파일 생성 보고서를 작성하는 AI입니다. 스키마 검증, 중복 탐지, 포맷 제안을 종합하여 최종 통합 파일의 품질 리포트를 작성하세요. 총 레코드 수, 플랫폼별 비중, 데이터 품질 점수(100점 만점)를 포함하세요. 마지막에 "✅ 통합 파일이 준비되었습니다. 다운로드 버튼을 클릭하세요."로 마무리하세요. 한국어로 답변하세요.',
};
